...
import { AllUsers, DeleteUser } from "../../../api/api";
...
const Users = () => {
  ...
  const deleteUser = async () => {
    ...
    const { data, error } = await DeleteUser(selectedDelete);
    if (data) {
  ...
  return (
    <Layout>
      {loading && <Loader />}
      <div className="w-[90%] mx-auto rounded-2xl shadow-2xl my-5 p-5 md:p-10">
        <WelcomeTopBar
          auth={auth}
        ...
        <div className="mt-5 grid grid-cols-12 lg:gap-10">
          ...
          <div className="col-span-12 lg:col-span-10">
            <div className="flex">
              <Link to="/dashboard/admin/users/create" className="ml-auto ">
                  ...
                  {users &&
                    users?.map((item) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <Link
                            to={`/dashboard/admin/users/update/${item?._id}`}
                          >
                        ...
                        <td className="px-6 py-4">
                          <button
                            onClick={(e) => handleDeleteUser(item?._id)}
