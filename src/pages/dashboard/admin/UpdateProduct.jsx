...
const UpdateProduct = () => {
  ...
  return (
    <Layout>
      {pageLoading && <Loader />}
      <div className="w-[90%]  p-10 rounded-2xl mt-5 shadow-2xl mx-auto mb-5 ">
        <form 
                      ...
                      onChange={(e) => {
                        ...
                        if ( e.target.files[0]) {
                          if ( fileList[count]) {
                            ...
                            console.log(tempFileList, index)
                          } else {
                            if (count === 0) {
                              tempFileList[count] = e.target.files[0]
                            } else {
