...
const SingleProduct = () => {
  ...
  const generateStars = (e) => {
    ...
    for (let i = 0; i < e; i++) {
      starArray.push(
        <span key={i}>
          <IconStar className="text-yellow-400 fill-yellow-400 mr-1 text-xs h-5 w-5" />
        </span>
      );
    }
    return starArray;
    ...
    <Layout>
                  ...
                  forbDecor.map((item) => (
                    <div key={item?.id} className={`mt-5 w-12 relative`}>
                      ...
                      <img
                        src={`${item?.img}`}
                        alt=""
                        onClick={(e) => setForbImage(item?.id)}
                        onMouseEnter={(e) => setHoverForbImage(item?.id)}
      ...
      <div className="w-[90%] md:w-[60%] lg:w-[65%] mx-auto md:mt-40">
        ...
        <div className="flex mt-10 gap-16">
          <div className="cursor-pointer" onClick={(e) => setDesRev("reviews")}>
            <h2
              className={`${
          ...
          <div
            ...
            onClick={(e) => setDesRev("description")}
          >
            <h2
              className={`
