...
function FeesFunctions({ MaterialCalculationList, setMaterialCalculationList, VeriableList, totalReset }) {
    ...
    const CreateCalculationMaterial = async () => {
        const { data, error } = await CreateCalculation(MaterialCalculationList, "addDataToFeesVariable", TestTottal)
        if (data) {
