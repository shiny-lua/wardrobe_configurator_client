...
function WorkingFunctions({ MaterialCalculationList, setMaterialCalculationList, VeriableList, totalReset }) {
    ...
    const CreateCalculationMaterial = async () => {
        const { data, error } = await CreateCalculation(MaterialCalculationList, "addDataToWorkingVariable", TestTottal)
        if (data) {
