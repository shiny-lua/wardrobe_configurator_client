...
function GeneralFunctions({ MaterialCalculationList, setMaterialCalculationList, VeriableList, totalReset }) {
    ...
    const CreateCalculationMaterial = async () => {
        const { data, error } = await CreateCalculation(MaterialCalculationList, "addDataToGeneralVariable", TestTottal)
        if (data) {
