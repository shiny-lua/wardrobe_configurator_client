...
const BottomProducts = () => {
  return (
    <>
      {/* ----------------------------Bottom Products------------------------ */}
      <div className="bg-[#F5F5F5] py-10 lg:py-14">
        <h1 className="mx-auto w-max font-bold text-2xl md:text-3xl lg:text-4xl">
          Zuletzt angesehen
        </h1>
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4 w-[90%] mx-auto mt-5">
          {productsData &&
            productsData
              .slice(0, 4)
              .map((item) => (
