...
const CheckOutForm = ({ data }) => {
  ...
  const creditCardPayment = () => {
    debugger;
    console.log("Cradit Card detail ", creditCardDetail);
    console.log("Delivery Address Detail ", deliveryAddress);
    console.log("Billing Address Detail ", billingAddress);
  };
