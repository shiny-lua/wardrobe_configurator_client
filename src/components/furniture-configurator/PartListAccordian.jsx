...
export const PartListAccordianAfter = ({ handleToggle, viewdata }) => {
  ...
  const dropdownOptionsEdge = [
    { label: "Add-Distance", icon: <div> <img onClick={(e) => setParlistFunctionOpen(!ParlistFunctionOpen)} width={20} height={20} src={settingsIcon} alt="setting-icon" /> </div > },
  ...
  const HandleFunctions = (value, item, parlistindex) => {
