            ...
            <div className="p-3  bg-white border border-gray rounded-2xl custom-shadow">
              ...
              <div className="p-5">
                ...
                <div className="text-center">
                  <button
                    type="button"
                    class="w-1/2 focus:outline-none text-white bg-[#547C5A] hover:bg-[#547C5A] focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
                  >
