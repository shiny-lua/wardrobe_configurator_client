...
import { ReactComponent as IconStar } from "../../../src/components/icons/star.svg";
      ...
      <div className="mt-5 md:mt-0">
        <div className="text-center p-5 md:p-10">
          ...
          <div className="flex w-max mx-auto mt-4">
            <span>
              <IconStar className="text-yellow-400 fill-yellow-400 mr-2" />
            </span>
            <span>
              <IconStar className="text-yellow-400 fill-yellow-400 mr-2" />
            </span>
                ...
                reviewsData.map((item) => (
                  <SplideSlide key={item?.id}>
                    <div className="text-center items-center">
                      <div className="flex w-max mx-auto mt-4">
                        <span>
                          <IconStar className="text-yellow-400 fill-yellow-400 mr-1" />
                        </span>
                        <span>
                          <IconStar className="text-yellow-400 fill-yellow-400 mr-1" />
                        </span>
