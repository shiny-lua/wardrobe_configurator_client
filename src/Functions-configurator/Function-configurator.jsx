...
export const GetallTexture = async (formdata) => {
  try {
...
export const CreatePartList = async (viewdata, PartListArray) => {
  ...
  console.log(PartListArray, "partlist view create")
...
export const getAllSettings = async () => {
  try {
    ...
    console.log("Error in getting All Settings info :", error)
    return { data: null, error: error?.response?.data }
  }
}
...
export const updateSettingVariable = async (data) => {
  ...
  try {
    ...
    console.log("Error in updating one setting variable:", error)
    return { data: null, error: error?.response?.data }
  }
}

export const deleteSettingVariable = async (_id) => {
