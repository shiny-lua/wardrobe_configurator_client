...
export default function ColorCard(props) {
      ...
      if (category === Config.color.category.body) {
        ...
        setBodyTexture({
          ...
          property: {
            ...
            normalScale: texture.normalScale? [texture.normalScale?.value?.x, texture.normalScale?.value?.x] : [0.45, 0.45],
  ...
  return (
    ...
    <div
      ...
      >
        <img src={imageUrl} draggable={false} className="border border-black rounded-[12px] rounded-tr-none shadow-lg" />
