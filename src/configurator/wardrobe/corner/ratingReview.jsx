...
import { ReactComponent as ReviewIcon } from "../../../assets/icons/review_icon.svg"
...
export default function RatingReview() {
  return (
    <div className="absolute right-[21px] bottom-[15px] w-[141px] h-[66px] rounded-[3px] border border-black bg-[#F6F6F6] flex flex-1">
      <div>
        <ReviewIcon className="ml-[-2px] mt-[-1px] w-[45px]" />
      </div>
      <div className="flex flex-col items-center gap-1.5 pt-1 w-full">
        <Rating
          ratedIcon={<StarIcon className="w-[13px] h-[13px]" />}
          readonly
          value={5}
        />
