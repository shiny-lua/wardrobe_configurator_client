...
import { ReactComponent as FrontIcon } from "../../../assets/icons/show_front.svg"
import { ReactComponent as DimensionIcon } from "../../../assets/icons/show_dimension.svg"
import { ReactComponent as AllIcon } from "../../../assets/icons/show_all.svg"
    ...
    <div className="bg-[#F6F6F6] absolute top-[9px] right-[7px] px-[12px] py-[8px]">
      ...
      {open && (
        <>
          ...
          >
            <DimensionIcon className="mr-[10px]" />
            Ansicht : Maße
          </Button>
          <Button
            className={`${
